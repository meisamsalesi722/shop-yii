...
class OrderController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->query->joinWith('orderItems.vendorProduct')->andWhere(['vendor_product.vendor_id' => Yii::$app->user->identity->vendor->id]);
    ...
    public function actionOrderItem($order_id)
    {
        ...
        $dataProvider->query->joinWith('vendorProduct')->andWhere(['vendor_product.vendor_id' => Yii::$app->user->identity->vendor->id]);
    ...
    public function actionOrderItemCreate($order_id)
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $transaction->commit();
                return $this->redirect(['/vendor/order/order-item/', 'order_id' => $order_id]);
                } catch (\Throwable $e) {
...
// -------------------- variant list ---------------------//
    ...
    public function actionEditAddress($order_id){
        ...
        return $this->renderAjax('/vendor/address/_form', [
            'model' => $model,
        ]);  
    }
