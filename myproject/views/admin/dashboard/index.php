        ...
        <div class="col-xl-3 col-lg-6 col-md-6">
            <div class="card border-0 shadow-sm hover-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-1">محصولات</h6>
                            <h2 class="fw-bold mb-0"><?= number_format($totalProducts) ?></h2>
                            <small class="text-success">
                                <i class="fas fa-arrow-up"></i> +<?= $todayProducts ?> امروز
                            </small>
                        </div>
                    ...
                    <div class="mt-3">
                        <span class="badge bg-success"><?= $publishedProducts ?> منتشر شده</span>
                        <span class="badge bg-warning"><?= $draftProducts ?> پیش‌نویس</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0">
                        <i class="fas fa-clock text-primary"></i> آخرین محصولات
                    </h5>
                    <?= Html::a(
                        ...
                        <?php foreach ($latestProducts as $product): ?>
                            <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <a href="<?= Url::to(['/admin/product/view', 'slug' => $product->slug]) ?>" 
                                       class="text-decoration-none text-dark fw-bold">
                                        <?= Html::encode($product->name) ?>
                                    </a>
                                    <br>
                                    <small class="text-muted">
                                        <i class="fas fa-user"></i> <?= Html::encode($product->user->username ?? 'ناشناس') ?>
                                        <span class="mx-1">|</span>
                                        <i class="far fa-clock"></i> <?= Yii::$app->formatter->asRelativeTime(strtotime($product->created_at)) ?>
                                    </small>
                                </div>
                            </div>
                        <?php endforeach; ?>
                            ...
                            <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted">
                                        ...
                                        <br>
                                        <i class="far fa-clock"></i> <?= Yii::$app->formatter->asRelativeTime(strtotime($comment->created_at)) ?>
                                    </small>
                                </div>
                            </div>
                        <?php endforeach; ?>
                                ...
                                <?php foreach ($popularProducts as $product): ?>
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <br>
                                            <small class="text-muted">
                                                <i class="fas fa-comment"></i> <?= $product->comment_count ?? 0 ?> نظر
                                            </small>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <small class="text-muted">
                                                ...
                                                <br>
                                                <i class="far fa-clock"></i> <?= Yii::$app->formatter->asRelativeTime(strtotime($user->created_at)) ?>
                                            </small>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                                ...
                                <a href="<?= Url::to(['/admin/category/view', 'id' => $category->id]) ?>" 
                                   class="text-decoration-none">
                                    <span class="badge bg-primary bg-opacity-10 text-primary p-3">
                                        ...
                                        <span class="badge bg-primary ms-2"><?= $category->product_count ?? 0 ?></span>
                                    </span>
                                </a>
                            <?php endforeach; ?>
                        </div>
