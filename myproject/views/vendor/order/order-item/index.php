...
<div class="order-item-index">
    ...
    <?php $form = ActiveForm::begin([
        'action' => Url::to(['/vendor/order/order-item-create' , 'order_id' =>  $order_id])
    ]); ?>
    ...
    $form->field($orderItemModel, 'product_variant_id')->widget(DepDrop::class, [
        ...
        'pluginOptions'=>[
            ...
            'placeholder' => 'Select...',
            'url' => Url::to(['/vendor/order/product-variant-list'])
        ]
    ])->label('مشخصات محصول');
    ?>
    ...
    $form->field($orderItemModel, 'vendor_product_id')->widget(DepDrop::class, [
        ...
        'pluginOptions'=>[
            ...
            'placeholder' => 'Select...',
            'url' => Url::to(['/vendor/order/vendor-product-list'])
        ]
    ])->label('قیمت، فروشنده');
    ?>
    ...
    <?=
        ...
        'pluginOptions'=>[
            ...
            'placeholder' => 'Select...',
            'url' => Url::to(['/vendor/order/product-count'])
        ]
    ])->label('تعداد');
    ?>
        ...
        'attributes' => [
            [
                ...
                'value' => function($model) use($order_id){
                    $url = Url::to(["/vendor/order/edit-address", 'order_id' => $order_id]);
        ...
        'columns' => [
            ...
            [
                 ...
                 'buttons' => [
                    'view' => function ($url, $model, $key) use($order_id){
                        return Html::a(
                            ...
                            ['vendor/order/order-item-view', 'id' => $model->id , 'order_id' => $order_id]
                        );
                    },
                    'update' => function ($url, $model, $key) use($order_id){
                        $url = Url::to(["/vendor/order/get-info", 'id' => $model->id, 'order_id' => $order_id]);
                ...
                'urlCreator' => function ($action, OrderItem $model, $key, $index, $column) use($order_id) {
                    return Url::toRoute([ 'vendor/order/order-item-' . $action, 'id' => $model->id , 'order_id' => $order_id]);
                 }
            ],
        ],
    ]); ?>
